...
public class ReservationController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<ActionResult<ReservationDTO>> CreateReservation([FromBody] CreateReservationAndContactInfoDTO createReservationAndContactInfoDto)
    {
        var reservation = await _reservationService.CreateReservation(createReservationAndContactInfoDto.CreateReservationDTO, createReservationAndContactInfoDto.CreateContactInfoDTO);
